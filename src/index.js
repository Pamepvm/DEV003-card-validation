  ...
  for (let i = 0; i < cardNumberArrayInverso.length; i++) {
    ...
    if (i % 2 !== 0) {
      ...
      if (multiplicacion >= 10) {
        ...
        // transformar multiplicación en array separados por una , y dividir la cadena en subcadena como arr
        const newArray = multiplicacion.toString().split('')
        //console.log(newArray)

        //sumando los digitos de la mutiplicacion y agrega un elemento
